...
public interface Annotation extends Comparable<Annotation> {
	...
	public enum Strand {
		...
		public static Strand consensusStrand(Strand strand1, Strand strand2) {
			...
			if(strand1==null){ strand1=BOTH;	}
			
			if(strand2==null){strand2=BOTH;}
		...
		public static Strand antisense(Strand orientation) {
			if(orientation.equals(Strand.POSITIVE)){return Strand.NEGATIVE;}
			if(orientation.equals(Strand.NEGATIVE)){return Strand.POSITIVE;}
			return orientation;
		}
	}
	...
	/**
	 * Return a collection of Annotations that represent the gaps in the blocks
	 * @return
	 */
	...
	/**
	 * Return windows spanning junctions
	 * @param binSize
	 * @return
	 */
	...
	/**
	 * 
	 * @return length of the annotation from start to end in genome (includes introns)
	 */
	public int getGenomicLength();
	
	/**
	 * 
	 * @return Exon-Exon pairs
	 */
