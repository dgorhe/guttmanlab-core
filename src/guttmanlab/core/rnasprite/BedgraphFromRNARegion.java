...
public class BedgraphFromRNARegion {
	...
	static Collection<SingleInterval> problemBins=new TreeSet<SingleInterval>();
		...
		public static void main(String[] args) throws IOException{
			if(args.length>4){
				...
				Map<SingleInterval, Double> map=data.getRNADNAContacts(binResolution, geneCoordinates, minCluster, maxCluster);
