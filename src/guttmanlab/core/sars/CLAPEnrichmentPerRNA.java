...
public class CLAPEnrichmentPerRNA {

	public CLAPEnrichmentPerRNA(String file1, String file2, String save) throws IOException{
		...
		for(SingleInterval pos: sample.keySet()){
			...
			writer.write(pos.getReferenceName()+"\t"+pos.getReferenceStartPosition()+"\t"+(pos.getReferenceStartPosition()+1)+"\t"+ratio+"\n");
	...
	public static void main(String[] args) throws IOException{
		if(args.length>2){
			...
			String input=args[1];
			String save=args[2];
			new CLAPEnrichmentPerRNA(sample, input, save);
		}
