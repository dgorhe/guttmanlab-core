...
public class SplicingRatios_TotalRNA {
	...
	public SplicingRatios_TotalRNA(File bamFile, Collection<Gene> genes, String save) throws IOException{
	...
	public SplicingRatios_TotalRNA(File bamFile, Collection<Gene> genes) throws IOException{
		Map<String, IntervalTree<Gene>> geneTree=makeTree(genes);
	...
	public static void main(String[] args)throws IOException{
		if(args.length>2){
			...
			//File bam2=new File(args[1]);
			Collection<Gene> genes=BEDFileIO.loadRegionsFromFile((args[1]));
			String save=args[2];
			SplicingRatios_TotalRNA sample1=new SplicingRatios_TotalRNA(bam1, genes, save);
			write(save, sample1.counts, genes);
			//write(save, sample1.counts, sample2.counts);
		}
