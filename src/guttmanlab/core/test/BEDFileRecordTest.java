...
public class BEDFileRecordTest {
	...
	public void testSimplestBEDBuilder() {
		...
		assertFalse(simplest.color().isPresent());
		assertFalse(simplest.score().isPresent());
	...
	public void testComplexBEDBuilder() {
		...
		assertEquals(complex.color().get(), COLOR_1);
		assertEquals((double)complex.score().get(), SCORE_1, EPSILON);
	...
	public void testStringParse3() {
		...
		assertFalse(threeField.color().isPresent());
		assertFalse(threeField.score().isPresent());
		assertEquals(threeField.getNumberOfBlocks(), 1);
		assertEquals(str3, threeField.toFormattedString());
	}
	...
	public void testStringParse4() {
		...
		assertFalse(fourField.color().isPresent());
		assertFalse(fourField.score().isPresent());
		assertEquals(fourField.getNumberOfBlocks(), 1);
		assertEquals(str4, fourField.toFormattedString());
	}
	...
	public void testStringParse5() {
		...
		assertFalse(fiveField.color().isPresent());
		assertEquals((double)fiveField.score().get(), SCORE_1, EPSILON);
		assertEquals(fiveField.getNumberOfBlocks(), 1);
		assertEquals(str5, fiveField.toFormattedString());
	}
	...
	public void testStringParse6() {
		...
		assertFalse(sixField.color().isPresent());
		assertEquals((double)sixField.score().get(), SCORE_1, EPSILON);
		assertEquals(sixField.getNumberOfBlocks(), 1);
		System.err.println(sixField.toFormattedString());
		
		// This method isn't invertible because default thickStart and thickEnd values
		// are generated if they are absent.
		assertEquals(BEDFileRecord.fromFormattedString(sixField.toFormattedString()).toFormattedString(), 
				sixField.toFormattedString());
	}
	...
	public void testStringParse8() {
		...
		assertFalse(eightField.color().isPresent());
		assertEquals((double)eightField.score().get(), SCORE_1, EPSILON);
		assertEquals(eightField.getNumberOfBlocks(), 1);
		assertEquals(str8, eightField.toFormattedString());
	}
	...
	public void testStringParse9() {
		...
		assertEquals(nineField.color().get(), COLOR_1);
		assertEquals((double)nineField.score().get(), SCORE_1, EPSILON);
		assertEquals(nineField.getNumberOfBlocks(), 1);
		assertEquals(str9, nineField.toFormattedString());
	}
	...
	public void testStringParse12() {
		...
		assertEquals(twelveField.color().get(), COLOR_1);
		assertEquals((double)twelveField.score().get(), SCORE_1, EPSILON);
		assertEquals(twelveField.getNumberOfBlocks(), 2);
		assertEquals(str12, twelveField.toFormattedString());
	}
}
