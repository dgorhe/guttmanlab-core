...
public class SplicingRatios {
	...
	private static void write(String save, Map<Gene, Pair<Integer>> sample1) throws IOException {
		FileWriter writer=new FileWriter(save);
		...
		for(Gene gene: allGenes){
			...
			writer.write(gene.getName()+"\t"+gene.getGenomicLength()+"\t"+count1.getValue1()+"\t"+count1.getValue2()+"\n");
		}
	...
	public static void main(String[] args)throws IOException{
		if(args.length>2){
			...
			String save=args[2];
			SplicingRatios sample1=new SplicingRatios(bam1, genes);
			write(save, sample1.counts);
		}
