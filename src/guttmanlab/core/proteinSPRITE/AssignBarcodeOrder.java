...
public class AssignBarcodeOrder {

	public AssignBarcodeOrder(BarcodingDataStreaming data, Map<String, String> barcodeToRound, String save) throws IOException {
		FileWriter writer1=new FileWriter(save+".truncated");
		FileWriter writer2=new FileWriter(save+".complete");
		FileWriter writer3=new FileWriter(save+".correct");
		FileWriter writer4=new FileWriter(save+".correct.single");
		
		//Collection<String[]> barcodes=new ArrayList<String[]>();
		
		Map<String, String[]> missingBarcodes=new TreeMap<String, String[]>();
		...
		//write(missingBarcodes);
		Map<String, Collection<String>> match=match(missingBarcodes, data);
		write(save, match);
	...
	public static void main(String[] args) throws IOException {
		...
		String save=args[2];
		new AssignBarcodeOrder(data, names, save);
	}
