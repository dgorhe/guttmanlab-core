...
public class PrimerPair implements Comparable<PrimerPair>{
	...
	public List<Sequence> getPrimerSequences() {
		...
		if(hasPrimers()) {
			Sequence leftPrimerSeq = new Sequence(getPrimerPairId() + "_left", leftPrimer);
			result.add(leftPrimerSeq);
			
			Sequence rightPrimerSeq = new Sequence(getPrimerPairId() + "_right", rightPrimer);
	...
	@Override
	public int compareTo(PrimerPair other) {
