...
public class Primer3IO {
	...
	public Collection<PrimerPair> checkPrimerPair(Primer3SequenceInputTags input, Primer3Configuration configuration) throws IOException {
		//writeRecord(new BufferedWriter(new OutputStreamWriter(System.out)), input, configuration);
		writeRecordCheckPrimer(primer3StdIn, input, configuration);
	...
	public void writeRecordCheckPrimer(BufferedWriter bw, Primer3SequenceInputTags input, Primer3Configuration conf) throws IOException {
